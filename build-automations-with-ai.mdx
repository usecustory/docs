---
title: "Build automations with AI"
...
- Read [Automations](/automations) for the underlying trigger, filter, and action model.
- Read [Templates](/automation-templates) if you want a faster starting point.
- Read [Overview](/integrations) if the workflow depends on tools you still need to connect.
