...
> Add screenshot of the empty journey editor or template picker here.

## Step 1: define the job of the journey

Before you create anything, write down what decision this journey should help your team make.

For example:

`We want to understand where trial users lose momentum before they become paying customers.`

That sentence matters because it keeps the map focused.
...
- use AI import if you already have source material

For a first pass, a template or AI draft is usually faster than starting from zero.

Name the journey clearly:

`Trial to paid`

Avoid names that are too broad or internal, such as `Growth motion` or `Funnel workstream`.

## Step 3: add the major stages
...
> Add screenshot of a journey with stages, steps, and a few linked items here.
