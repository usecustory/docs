...
description: "Follow the main onboarding walkthrough to turn a draft or blank journey into a first map your team can actually use for activation, conversion, retention, or another high-value flow."
icon: "pencil"
---

Use this guide when you want to turn your first journey into something the team can review, prioritize from, and act on quickly.
...
That is why a first journey can produce value quickly. It does not just document the flow. It helps the team make a better decision about activation, conversion, retention, or another meaningful product outcome.
