...
Use this guide when you want to build the first usable journey inside Custory. It assumes your workspace already exists and you already chose the flow you want to map.
