...
Use this guide when you want to build a first journey that your team can review, maintain, and use for decisions this week.

## What this is

This is a mini-tutorial for building a realistic first journey in Custory.
...
<Steps>
  ...
  <Step title="Create the journey">
    Start blank, start from a template, or use AI import if you already have source material. For a first pass, a template or AI draft is usually faster than starting from zero.
  </Step>
