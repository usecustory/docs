...
Read [Automations](/automations) if you want the setup model, or [Templates](/automation-templates) if you want examples to copy.
...
- Read [Automations](/automations) when you want repeated follow-up to happen automatically.
