...
<div>
  <img
    src="/images/diagrams/itemdetailsLIGHT.webp"
    alt="Custory item details with links and comments in light mode"
    className="block dark:hidden rounded-xl border border-gray-200"
  />
  <img
    src="/images/diagrams/itemdetailsDARK.webp"
    alt="Custory item details with links and comments in dark mode"
