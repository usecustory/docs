...
Each item type should do a specific job.

### Keeping evidence outside the item

If the proof lives only in Slack, a ticket, or somebody's memory, the map becomes weaker.

### Creating lots of items without linking the reasoning

The evidence-to-action chain matters.
