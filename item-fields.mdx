...
Links are how Custory keeps the reasoning visible instead of leaving the work as disconnected notes.
...
Use these to answer where the experience is happening and who is involved.
...
Too much structure too early creates overhead.

### Linking everything to everything

If every item links to every other item, traceability becomes noise.

### Treating opportunities like raw note buckets

Keep learnings, problems, and responses separate enough to reason about them clearly.
