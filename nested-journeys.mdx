...
<AccordionGroup>
  <Accordion title="Splitting too early">
    Map the broad flow first. Then split only where detail is actually blocking understanding or creating review friction.
  </Accordion>
  <Accordion title="Creating microjourneys with no clear owner">
    If nobody will maintain the child journey, it becomes dead weight. Only create a nested journey when someone will review and update it as a real operating asset.
  </Accordion>
  <Accordion title="Using nested journeys as folders">
    They are not just organizational containers. They are real linked journeys that should earn their place by improving clarity, not by adding structure for its own sake.
  </Accordion>
</AccordionGroup>
