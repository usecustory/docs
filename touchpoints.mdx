...
### Link touchpoints to the insight they produced

If the team learns something important from a support thread or onboarding step, connect that learning directly. This preserves the origin of the signal.
